                                            ...
                                            <div class="mt-4 pt-3 text-center">
                                                <div class="row justify-content-center">
                                                    <div class="col-6 my-4">
                                                        <img src="{{ asset('template/images/maintenance.svg') }}" title="">
                                                    </div>
                                                </div>
                                                <h3 class="expired-title mb-4 mt-3">Situs sedang dalam pengembangan</h3>
                                                <p class="text-muted mt-3"> Jangan khawatir, kami akan segera kembali.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
