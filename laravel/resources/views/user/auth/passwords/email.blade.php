                                ...
                                <div class="col-md-8 col-lg-5">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-12 text-center">
                                            <p class="text-dark-50 mb-0"><a href="{{ url('auth/login') }}" class="text-dark-50 ml-1"><b>Masuk</b></a> - <a href="{{ url('auth/register') }}" class="text-dark-50 ml-1"><b>Daftar</b></a></p>
                                        </div>
                                    </div>
                                    @else
                                    <div class="row mt-4">
                                        <div class="col-sm-12 text-center">
                                            <p class="text-dark-50 mb-0"><a href="{{ url('auth/login') }}" class="text-dark-50 ml-1"><b>Masuk</b></a></p>
                                        </div>
                                    </div>
                                    @endif
                                </div>
